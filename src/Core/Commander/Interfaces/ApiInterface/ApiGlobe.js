...
ApiGlobe.prototype.addFeatureLayer = function addFeatureLayer(layer) {
    const provider = this.scene.managerCommand.getProtocolProvider(layer.protocol);
...
ApiGlobe.prototype.pickFeatureLayer = function pickFeatureLayer(layerId, geoCoord) {
    ...
    if (polygons) {
        const tools = this.scene.managerCommand.getProtocolProvider('wfs').featureToolBox;
...
ApiGlobe.prototype.createSceneGlobe = function createSceneGlobe(coordCarto, viewerDiv) {
    ...
    this.scene.managerCommand.addProtocolProvider('wfs', new WFS_Provider(ellipsoid));
    this.scene.managerCommand.addProtocolProvider('kml', new KML_Provider(ellipsoid));
